        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    ...
                    <a href="#" class="button" style="background-color:#4070F4; width: 50%">Promoting responsive market worth of public trust</a>
                </div>
            ...
            <section class="about section " id="skills">
                ...
                <div class="about__container bd-grid">
                    <div class="about__img">
                        <img src="assets/img/MSE.pNg" alt=" logo">
                    </div>
            ...
            <section class="contact section" id="skills">
                ...
                <div class="contact__container bd-grid">
                    <form action="Adminloginprocess.php" method="post" class="contact__form">
                   ...
                   <i>  <b>   <label for="PASSWORD">PASSWORD</label> <br></b></i>
                       ...
                       <br>
                        ...
                        <input type="submit" value="Sign IN" class="contact__button button">
                    </form>
                </div>
            </section>  
            </section>
